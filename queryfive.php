...
$sql = "SELECT insurance.pid, patient.name, insurance.amount, insurance.policynumber, insurance.dateofmaturity
FROM patient
...
. $row["amount"]. "</td><td>" .$row["policynumber"] . "</td><td>" .$row["dateofmaturity"] . "</td></tr>";
}
echo "</table>";
} else { echo "0 results"; }
$conn->close();
